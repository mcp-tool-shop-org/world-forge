...
- **[ai-rpg-engine](https://github.com/mcp-tool-shop-org/ai-rpg-engine)** : format ContentPack — le runtime de simulation déterministe qui charge un pack exporté et exécute le monde.
