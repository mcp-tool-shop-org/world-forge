...
- **[ai-rpg-engine](https://github.com/mcp-tool-shop-org/ai-rpg-engine)**: formato ContentPack — el runtime de simulación determinista que carga un paquete exportado y ejecuta el mundo.
