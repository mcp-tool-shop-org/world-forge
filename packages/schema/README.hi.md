...
- **स्थानिक:** `WorldMap` (विश्व मानचित्र), `Zone` (क्षेत्र), `ZoneExit` (क्षेत्र से बाहर निकलने का मार्ग), `ZoneConnection` (क्षेत्र कनेक्शन), `Landmark` (महत्वपूर्ण स्थान), `Interactable` (इंटरैक्ट करने योग्य), `ZoneEntryGate`।
...
- **कस्बा और संरचनाएं:** `Building`, `Hub`, `Stronghold`।
- **विश्व मॉडलिंग:** `Stratum`, `StratumLink` (ऊर्ध्वाधर परतें), `HazardDefinition` (टाइप किए गए प्रभाव यूनियन), तथा `ZoneEntryGate` को चलाने वाले पार्टी-स्टेट `SpawnCondition` ऑपरेंड।
...
- **सत्यापन:** `validateProject()` — क्रमांकित संरचनात्मक जांच `src/validate.ts` में रहती हैं (प्रकाशित संख्या को अनुबंध न मानें)।
