...
const chapelThreshold: WorldProject = {
  ...
  zones: [
    ...
    { id: 'chapel-alcove', name: 'Chapel Alcove', tags: ['interior', 'hidden'], description: 'A side niche concealing a passage downward.', gridX: 22, gridY: 22, gridWidth: 5, gridHeight: 4, neighbors: ['chapel-nave'], exits: [{ targetZoneId: 'crypt-chamber', label: 'Descend to Crypt', condition: 'item:chapel-key' }], light: 2, noise: 0, hazards: [], interactables: [{ name: 'Hidden Lever', type: 'use', description: 'A lever disguised as a wall sconce.' }], parentDistrictId: 'chapel-grounds' },
  ...
  connections: [
    ...
    { fromZoneId: 'chapel-alcove', toZoneId: 'crypt-chamber', bidirectional: true, kind: 'secret', condition: 'item:chapel-key' },
  ],
