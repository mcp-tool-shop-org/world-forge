...
<!-- version:start -->
<p align="center"><strong>v4.4.1</strong> — 2155 tests + 6 e2e browser checks, 6 shipping packages, 7 authoring modes, 2.5D authoring, three export targets (AI RPG Engine, Unreal Engine 5, Godot 4)</p>
<!-- version:end -->
